                ...
                <div class="row g-4">
                    <div class="col-12">
                        <div class="bg-light rounded h-100 p-4">
                            ...
                            <a href="{{ route('taocongviec') }}"> <button type="button" class="btn btn-square btn-primary m-2"><i class="fa fa-plus"></i></button></a>
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            @endswitch
                                            <td>
                                                <a href="{{url('congviec/chitietcongviec/')}}/{{ $item->magiao }}"><button type="button" class="btn btn-sm btn-sm-square btn-outline-primary m-2"><i class="fa fa-info"></i></button>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
