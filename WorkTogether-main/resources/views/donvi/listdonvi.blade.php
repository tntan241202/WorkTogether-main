                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-12">
                        <div class="bg-light rounded h-100 p-4">
                            ...
                            <form class="d-none d-md-flex ms-4" action="{{route('Searchdonvi')}}" method="get">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <!-- <a href="{{url("XoaDonVi/{$item->MaDV}")}}"  type="button" class="btn btn-sm btn-sm-square btn-outline-primary m-2"><i class="fa fa-del"></i> Xóa </button> </a>  -->
                                            </td> 
                                        </tr>
                                        @endforeach
                                    </tbody>
