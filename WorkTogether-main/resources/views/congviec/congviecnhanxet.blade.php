                ...
                <div class="row g-4">
                    <div class="col-12">
                        <div class="bg-light rounded h-100 p-4">
                            <h6 class="mb-4">Danh Sách Công Việc Hoàn Thành</h6>
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            @endswitch
                                            <td>
                                                <a href="{{url('congviec/nhanxetcv/')}}/{{ $item->MaCV }}"><button type="button" class="btn btn-sm btn-sm-square btn-outline-primary m-2"><i class="fa fa-info"></i></button>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
